<section>
    <header>
        <h2 class="text-lg font-semibold text-slate-950">Update Password</h2>
        <p class="mt-1 text-sm leading-6 text-slate-600">Gunakan password yang kuat supaya akun rental tetap aman.</p>
    </header>

    <form method="post" action="{{ route('password.update') }}" class="mt-6 max-w-2xl space-y-5">
        @csrf
        @method('put')
